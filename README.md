##### Liyanjie.Pinyin
- 基于 **结巴分词**(https://github.com/anderscui/jieba.NET)
- 主要方法
```csharp
string[] Liyanjie.Pinyin.PinyinHelper.GetPinyin(string input)
```
##### Liyanjie.Pinyin.ChineseChar
- 基于 **汉字拼音数据**(https://github.com/mozillazg/pinyin-data) **/master/pinyin.txt**
- 主要方法
```csharp
...
- 基于 **词语拼音数据**(https://github.com/mozillazg/phrase-pinyin-data) **/master/large_pinyin.txt**
- 主要方法
```csharp
